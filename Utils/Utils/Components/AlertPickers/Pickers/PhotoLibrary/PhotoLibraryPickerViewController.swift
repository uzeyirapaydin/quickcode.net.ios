...
//            }
        ...
        case .denied, .restricted:
            ...
            let alert = UIAlertController(title: NSLocalizedString("Permission denied", comment: ""), message: "\(productName)" + NSLocalizedString(" does not have access to photos. Please, allow the application to access to your photo library.", comment: ""), preferredStyle: .alert)
